  ...
  return (
    <div className="mb-20 mt-8 flex flex-row items-center self-center">
      ...
      <div className="ml-3 max-w-md">
        ...
        <p>Please consider <a href="https://github.com/sponsors/ospfranco" className="text-pink-500">sponsoring</a>, also star the project on <a href="https://github.com/ospfranco/cidemon" className="text-blue-500">github</a> so we can release it on homebrew!</p>
      </div>
    </div>
  )
}